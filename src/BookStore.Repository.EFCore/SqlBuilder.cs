...
public class SqlBuilder
{
    ...
    public SqlBuilder OrderBy(string sql, dynamic? parameters = null, bool isAsc = true)
    {
        var orderDirection = isAsc ? "ASC" : "DESC";
        return AddClause("orderby", sql, parameters, " , ", "ORDER BY ", $" {orderDirection}\n", false);
    }
    ...
    public SqlBuilder Fetch(int offset, int next)
    {
        return AddClause("fetch", "", null, "  ", $"OFFSET {offset} ROWS FETCH NEXT {next} ROWS ONLY ", "\n", false);
    }
}
